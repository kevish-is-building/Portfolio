...
const socialLinks = [
  {
    name: 'YouTube',
    url: 'https://www.youtube.com/@KEVISH07',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 16 15" fill="#ff0000">
  ...
  },
  {
    ...
    hoverColor: 'hover:bg-gradient-to-r hover:from-orange-500 hover:via-pink-500 hover:to-purple-600'
  },
  {
    name: 'X',
  ...
  {
    name: 'GitHub',
    url: 'https://github.com/kevish-is-building/',
    icon: (
...
export default function Footer() {
  return (
    <footer className="py-8 bg-white/80">
